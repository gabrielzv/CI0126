...
namespace backend_lab_C28741.Handlers
{
    public class PaisesHandler
    {
        ...
        public PaisesHandler()
        {
            ...
            if (string.IsNullOrEmpty(_rutaConexion))
            {
                throw new InvalidOperationException("Connection string 'PaisesContext' is not defined.");
            }
